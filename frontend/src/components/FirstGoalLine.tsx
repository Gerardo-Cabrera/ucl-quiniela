...
interface Props {
  ...
  match: Match;
  /** Mostrar "· real: X". Partidos lo desactiva porque ya muestra el primer gol real
   *  en su propia fila (para todos, con o sin pronóstico). */
  showReal?: boolean;
}

/** Línea de primer gol de una tarjeta de pronóstico, con el formato de referencia:
 *  "⚽ elegido · real: X ✓ +N". El elegido va en dorado si acertó (comparado por id,
 *  como el scoring); ✓/✗ en cuanto se conoce el primer gol real (en vivo o
 *  finalizado); "+N" solo cuando ya está puntuado (los puntos se calculan al
 *  terminar). Un solo componente para Partidos, Pronósticos y el modal de otros. */
